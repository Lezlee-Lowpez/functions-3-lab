...
// const new1 = 8175133 +3792621 +2695598+ 2100263
// console.log(new1)
...
*/
// console.log(monstersInYourPocket['CP'])
...
// const myStrongest = monstersInYourPocket.filter(highCp())
...
// add in the sales tax -->map and the add up the total --> reduce
// add then save to an array 
// function priceAfterTax () {
//   return
// }

// const priceAfterTax = orders.map(value => value.price + value.tax)
...
*/
// .reduce(callback function, startingValue)

const bobsTotal = purchases.filter(value => value.owner ==='Bob').reduce((acc,curr)=> acc + curr.price, 0)
